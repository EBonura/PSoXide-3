...
fn main() {
    ...
    let exe_bytes = std::fs::read(
        "/Users/ebonura/Desktop/repos/psoxide/build/examples/mipsel-sony-psx/release/showcase-textured-sprite.exe",
    )
    .expect("showcase-textured-sprite.exe");
...
fn dump_ppm(bus: &Bus, frame: u64) {
    ...
    let path = format!("/tmp/showcase-textured-sprite-f{frame:03}.ppm");
