//! Composable 3D transform math on top of the raw GTE macros.
//!
//! The raw [`mtc2!`][crate::mtc2!] / [`ctc2!`][crate::ctc2!] macros in
//! [`regs`][crate::regs] give you direct register access. Everything
//! here sits above that: it builds rotation matrices on the CPU,
//! composes them, then pushes the result into the GTE as RT when the
//! caller is ready to project vertices.
//!
